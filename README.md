...
A local subtitle pipeline for Japanese video content. Transcribes video to ASS subtitles using Whisper large-v2, generates bilingual JP/CN subtitle files, translates empty CN lines via your choice of LLM backend (Gemini, Claude, OpenAI, or local Ollama), and burns the finished subtitles into the output video using ffmpeg.
